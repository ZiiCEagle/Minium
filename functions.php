...
function minium_scripts() {
    ...
    if ( is_singular() ) {
        wp_enqueue_style( 'highlight', "//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.8.0/styles/ocean.min.css" );
        wp_enqueue_script( 'highlight', "//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.8.0/highlight.min.js", [], false, true );
